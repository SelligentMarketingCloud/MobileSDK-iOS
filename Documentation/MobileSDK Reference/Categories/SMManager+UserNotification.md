...
<code>- (void)didReceiveNotificationResponse:(UNNotificationResponse *_Nonnull)*response* withCompletionHandler:(void ( ^ _Nullable ) ( UNNotificationContentExtensionResponseOption option ))*completionHandler*</code>
