...
#define SMSKeychain_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
// Keychain access group available at compile time
#define SMSKeychain_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef SMSKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, SMSKeychainQuerySynchronizationMode) {
    SMSKeychainQuerySynchronizationModeAny,
    SMSKeychainQuerySynchronizationModeNo,
    SMSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface SMSKeychainQuery : NSObject
...
#ifdef SMSKeychain_ACCESS_GROUP_AVAILABLE
...
@property (nonatomic) SMSKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 SMSKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
