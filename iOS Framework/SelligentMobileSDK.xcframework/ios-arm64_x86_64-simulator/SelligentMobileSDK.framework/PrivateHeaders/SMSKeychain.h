...
/**
 Error code specific to SMSKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, SMSKeychainErrorCode) {
    /** Some of the arguments were invalid. */
    SMSKeychainErrorBadArguments = -1001,
};

/** SMSKeychain error domain */
extern NSString *const kSMSKeychainErrorDomain;

/** Account name. */
extern NSString *const kSMSKeychainAccountKey;
 ...
 */
extern NSString *const kSMSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kSMSKeychainClassKey;

/** Item description. */
extern NSString *const kSMSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kSMSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kSMSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kSMSKeychainWhereKey;
...
/**
 ...
 SMSKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface SMSKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in SMSKeychain.h for a list of keys that can be used when accessing the
