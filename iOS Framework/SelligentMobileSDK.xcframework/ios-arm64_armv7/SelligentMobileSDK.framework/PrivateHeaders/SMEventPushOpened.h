...
+ (instancetype)eventWithPushID:(NSString*)pushID Dictionary:(NSDictionary*)dict MessageNature:(SMMessageNature)messageNature DisplayMode:(SMDisplayMode)displayMode;
