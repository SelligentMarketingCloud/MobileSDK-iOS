...
extern NSString *const SMSDWebImageDownloadReceiveResponseNotification;
extern NSString *const SMSDWebImageDownloadStopNotification;
extern NSString *const SMSDWebImageDownloadFinishNotification;

@interface SMSDWebImageDownloaderOperation : NSOperation <SMSDWebImageOperation, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
